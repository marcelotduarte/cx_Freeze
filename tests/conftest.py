...
def fix_test_path() -> Path:
    """Fixture that returns the root of the test folder."""
    return Path(__file__).resolve().parent


@pytest.fixture()
def fix_test_samples_path(fix_test_path: Path) -> Path:
    """Fixture that returns the samples folder for the tests."""
...
def fix_main_samples_path(fix_test_path: Path) -> Path:
    """Fixture that returns the cx_Freeze samples folder."""
