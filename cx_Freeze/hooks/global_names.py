...
SCIPY_CLUSTER_GLOBAL_NAMES = ["hierarchy", "vq"]
SCIPY_CONSTANTS_GLOBAL_NAMES = [
    "Avogadro",
    "Boltzmann",
    "Btu",
    "Btu_IT",
...
SCIPY_DIFFERENTIATE_GLOBAL_NAMES = ["derivative", "hessian", "jacobian"]
SCIPY_FFTPACK_GLOBAL_NAMES = [
    "cc_diff",
    "cs_diff",
    "dct",
    "dctn",
