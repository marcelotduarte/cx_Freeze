...
def parse_command_line(parser):
    ...
    if args.script is None and args.include_modules is None:
    ...
    if args.exclude_modules:
        args.exclude_modules = args.exclude_modules.split(",")
    else:
        args.exclude_modules = []
    if args.include_modules:
        args.include_modules = args.include_modules.split(",")
    else:
...
def main():
    ...
    freezer = cx_Freeze.Freezer(
        executables,
        includes=args.include_modules,
        excludes=args.exclude_modules,
        replacePaths=args.replace_paths,
        compress=args.compress,
        optimizeFlag=args.optimized,
        path=None,
