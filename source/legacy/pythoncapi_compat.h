...
#if PY_VERSION_HEX < 0x030C00A2 && !defined(PYPY_VERSION)
static inline PyObject* PyFrame_GetVarString(
...
static inline PyInterpreterState* PyThreadState_GetInterpreter(
...
#if !defined(PYPY_VERSION)
static inline PyFrameObject* _PyThreadState_GetFrameBorrow(
    PyThreadState* tstate)
{
...
static inline int PyObject_GetOptionalAttr(
    PyObject* obj, PyObject* attr_name, PyObject** result)
{
...
static inline int PyObject_GetOptionalAttrString(
...
#if PY_VERSION_HEX < 0x030D00A1
static inline int PyMapping_GetOptionalItem(
    PyObject* obj, PyObject* key, PyObject** result)
{
...
static inline int PyMapping_GetOptionalItemString(
    PyObject* obj, const char* key, PyObject** result)
{
    PyObject* key_obj;
    int rc;
#if PY_VERSION_HEX >= 0x03000000
...
#if PY_VERSION_HEX < 0x030D00A1
static inline int PyMapping_HasKeyWithError(PyObject* obj, PyObject* key)
{
    PyObject* res;
...
static inline int PyMapping_HasKeyStringWithError(
    PyObject* obj, const char* key)
{
    PyObject* res;
...
#if PY_VERSION_HEX < 0x030D00A1
static inline int PyObject_HasAttrWithError(PyObject* obj, PyObject* attr)
{
    PyObject* res;
...
static inline int PyObject_HasAttrStringWithError(
...
// to Python 3.13.0a1
#if PY_VERSION_HEX < 0x030D00A1
static inline int PyDict_GetItemRef(
    PyObject* mp, PyObject* key, PyObject** result)
{
#if PY_VERSION_HEX >= 0x03000000
...
static inline int PyDict_GetItemStringRef(
    PyObject* mp, const char* key, PyObject** result)
{
    int res;
#if PY_VERSION_HEX >= 0x03000000
...
#if PY_VERSION_HEX < 0x030D00A1
static inline int PyModule_Add(
    PyObject* mod, const char* name, PyObject* value)
{
...
#if PY_VERSION_HEX < 0x030D00A1
static inline int PyObject_VisitManagedDict(
...
static inline void PyObject_ClearManagedDict(PyObject* obj)
{
    PyObject** dict = _PyObject_GetDictPtr(obj);
    if (dict == NULL || *dict == NULL) {
        return;
...
// to Python 3.13.0a1
#if PY_VERSION_HEX < 0x030D00A1
static inline int PyUnicode_EqualToUTF8AndSize(
    PyObject* unicode, const char* str, Py_ssize_t str_len)
{
    Py_ssize_t len;
    const void* utf8;
...
static inline int PyList_Extend(PyObject* list, PyObject* iterable)
{
    return PyList_SetSlice(list, PY_SSIZE_T_MAX, PY_SSIZE_T_MAX, iterable);
}

static inline int PyList_Clear(PyObject* list)
{
...
static inline int PyDict_PopString(
    PyObject* dict, const char* key, PyObject** result)
{
    PyObject* key_obj = PyUnicode_FromString(key);
    if (key_obj == NULL) {
        if (result != NULL) {
...
static inline PyObject* PyList_GetItemRef(PyObject* op, Py_ssize_t index)
{
...
// gh-114329 added PyList_GetItemRef() to Python 3.13.0a4
#if PY_VERSION_HEX < 0x030D00A4
static inline int PyDict_SetDefaultRef(
...
static inline int PyUnicodeWriter_WriteChar(
    PyUnicodeWriter* writer, Py_UCS4 ch)
{
    if (ch > 0x10ffff) {
        PyErr_SetString(
            PyExc_ValueError, "character must be in range(0x110000)");
        return -1;
    }
...
static inline int PyUnicodeWriter_WriteStr(
    PyUnicodeWriter* writer, PyObject* obj)
{
...
static inline int PyUnicodeWriter_WriteRepr(
    PyUnicodeWriter* writer, PyObject* obj)
{
...
static inline int PyUnicodeWriter_WriteUTF8(
...
static inline int PyUnicodeWriter_WriteWideChar(
...
static inline int PyUnicodeWriter_WriteSubstring(
...
static inline int PyUnicodeWriter_Format(
    PyUnicodeWriter* writer, const char* format, ...)
{
    va_list vargs;
...
static inline void _PyLong_SetSignAndDigitCount(
    PyLongObject* op, int sign, Py_ssize_t size)
{
...
static inline Py_ssize_t _PyLong_DigitCount(const PyLongObject* op)
{
#if PY_VERSION_HEX >= 0x030C0000
...
static inline digit* _PyLong_GetDigits(const PyLongObject* op)
{
#if PY_VERSION_HEX >= 0x030C0000
...
static inline const PyLongLayout* PyLong_GetNativeLayout(void)
{
...
static inline int PyLong_Export(PyObject* obj, PyLongExport* export_long)
{
    if (!PyLong_Check(obj)) {
...
static inline void PyLong_FreeExport(PyLongExport* export_long)
{
...
static inline PyLongWriter* PyLongWriter_Create(
    int negative, Py_ssize_t ndigits, void** digits)
{
    if (ndigits <= 0) {
...
static inline void PyLongWriter_Discard(PyLongWriter* writer)
{
...
static inline PyObject* PyLongWriter_Finish(PyLongWriter* writer)
{
