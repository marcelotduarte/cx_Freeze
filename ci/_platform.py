...
PLATFORM_SUPPORT = {
    "linux": "64,arm64".split(","),
    "macos": "64,arm64".split(","),
    "mingw": "clang64,mingw64,ucrt64,mingw32".split(","),
    "windows": "32,64,arm64".split(","),
}
...
def main() -> None:
    ...
    data = {k: v for k, v in data.items() if k.startswith("pyside")}
    matrix = []
