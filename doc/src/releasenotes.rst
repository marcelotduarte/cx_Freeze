...
#)  build(deps-dev): bump bump-my-version from 0.20.0 to 0.20.1 (:pull:`2337`) :user:`49699333+dependabot[bot]`
...
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2324`) :user:`66853113+pre-commit-ci[bot]`
...
#)  build(deps-dev): bump bump-my-version from 0.19.3 to 0.20.0 (:pull:`2320`) :user:`49699333+dependabot[bot]`
...
#)  build(deps-dev): bump pytest-mock from 3.12.0 to 3.14.0 (:pull:`2311`) :user:`49699333+dependabot[bot]`
...
#)  build(deps-dev): bump sphinx-new-tab-link from 0.3.1 to 0.4.0 (:pull:`2306`) :user:`49699333+dependabot[bot]`
...
#)  build(deps-dev): bump coverage from 7.4.3 to 7.4.4 (:pull:`2301`) :user:`49699333+dependabot[bot]`
#)  build-wheel: use macos-14 (native arm) with cibuildwheel (:pull:`2299`) :user:`marcelotduarte`
#)  build(deps): update wheel requirement from <=0.42.0,>=0.38.4 to >=0.38.4,<=0.43.0 (:pull:`2298`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump cibuildwheel from 2.16.5 to 2.17.0 (:pull:`2297`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump bump-my-version from 0.18.3 to 0.19.0 (:pull:`2296`) :user:`49699333+dependabot[bot]`
...
#)  build(deps-dev): bump sphinx-new-tab-link from 0.3.0 to 0.3.1 (:pull:`2292`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump pytest from 8.0.2 to 8.1.1 (:pull:`2291`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump pytest-timeout from 2.2.0 to 2.3.1 (:pull:`2289`) :user:`49699333+dependabot[bot]`
...
#)  build(deps-dev): bump sphinx-new-tab-link from 0.2.3 to 0.3.0 (:pull:`2282`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump sphinx-new-tab-link from 0.2.2 to 0.2.3 (:pull:`2279`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump coverage from 7.4.2 to 7.4.3 (:pull:`2278`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump pytest from 8.0.1 to 8.0.2 (:pull:`2277`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump bump-my-version from 0.17.4 to 0.18.3 (:pull:`2276`) :user:`49699333+dependabot[bot]`
#)  bdist_msi: remove unused code (:pull:`2270`) :user:`marcelotduarte`
#)  build(deps-dev): bump coverage from 7.4.1 to 7.4.2 (:pull:`2271`) :user:`49699333+dependabot[bot]`
...
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2266`) :user:`66853113+pre-commit-ci[bot]`
#)  build(deps-dev): bump pytest from 8.0.0 to 8.0.1 (:pull:`2265`) :user:`49699333+dependabot[bot]`
...
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2257`) :user:`66853113+pre-commit-ci[bot]`
#)  build(deps-dev): bump furo from 2023.9.10 to 2024.1.29 (:pull:`2256`) :user:`marcelotduarte`
#)  build(deps-dev): bump bump-my-version from 0.17.3 to 0.17.4 (:pull:`2255`) :user:`49699333+dependabot[bot]`
...
#)  build(deps): bump codecov/codecov-action from 3 to 4 (:pull:`2238`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump sphinx-new-tab-link from 0.2.1 to 0.2.2 (:pull:`2245`) :user:`49699333+dependabot[bot]`
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2243`) :user:`66853113+pre-commit-ci[bot]`
...
#)  build(deps-dev): bump cibuildwheel from 2.16.4 to 2.16.5 (:pull:`2237`) :user:`49699333+dependabot[bot]`
...
#)  build(deps-dev): bump cibuildwheel from 2.16.2 to 2.16.4 (:pull:`2229`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump bump-my-version from 0.17.1 to 0.17.3 (:pull:`2228`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump pytest from 7.4.4 to 8.0.0 (:pull:`2227`) :user:`49699333+dependabot[bot]`
...
#)  build(deps-dev): bump bump-my-version from 0.17.0 to 0.17.1 (:pull:`2222`) :user:`49699333+dependabot[bot]`
...
#)  build(deps-dev): bump pluggy from 1.3.0 to 1.4.0 (:pull:`2217`) :user:`49699333+dependabot[bot]`
#)  parser: minor fix to support lief 0.14 (:pull:`2216`) :user:`marcelotduarte`
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2215`) :user:`66853113+pre-commit-ci[bot]`
#)  build(deps-dev): bump sphinx-tabs from 3.4.4 to 3.4.5 (:pull:`2214`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump bump-my-version from 0.16.2 to 0.17.0 (:pull:`2213`) :user:`49699333+dependabot[bot]`
...
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2202`) :user:`66853113+pre-commit-ci[bot]`
#)  build(deps-dev): bump bump-my-version from 0.16.1 to 0.16.2 (:pull:`2201`) :user:`49699333+dependabot[bot]`
...
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2195`) :user:`66853113+pre-commit-ci[bot]`
#)  build(deps-dev): bump bump-my-version from 0.16.0 to 0.16.1 (:pull:`2194`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump bump-my-version from 0.15.4 to 0.16.0 (:pull:`2191`) :user:`49699333+dependabot[bot]`
...
#)  build(deps-dev): bump pytest from 7.4.3 to 7.4.4 (:pull:`2188`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump bump-my-version from 0.15.3 to 0.15.4 (:pull:`2186`) :user:`49699333+dependabot[bot]`
...
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2181`) :user:`66853113+pre-commit-ci[bot]`
#)  build(deps-dev): bump bump-my-version from 0.15.1 to 0.15.3 (:pull:`2178`) :user:`49699333+dependabot[bot]`
#)  build-wheel: fix update_bases' ref and cleanup publish (:pull:`2176`) :user:`marcelotduarte`
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2175`) :user:`66853113+pre-commit-ci[bot]`
#)  build(deps-dev): bump bump-my-version from 0.12.0 to 0.15.1 (:pull:`2174`) :user:`49699333+dependabot[bot]`
...
#)  build(deps): bump actions/download-artifact from 3 to 4 (:pull:`2163`) :user:`49699333+dependabot[bot]`
#)  build(deps): bump actions/upload-artifact from 3 to 4 (:pull:`2162`) :user:`49699333+dependabot[bot]`
#)  build(deps): bump github/codeql-action from 2 to 3 (:pull:`2160`) :user:`49699333+dependabot[bot]`
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2157`) :user:`66853113+pre-commit-ci[bot]`
#)  build(deps-dev): bump pylint from 3.0.2 to 3.0.3 (:pull:`2156`) :user:`49699333+dependabot[bot]`
#)  build(deps): bump actions/setup-python from 4 to 5 (:pull:`2155`) :user:`49699333+dependabot[bot]`
...
#)  build(deps): bump wheel from 0.41.3 to 0.42.0 (:pull:`2148`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump bump-my-version from 0.11.0 to 0.12.0 (:pull:`2147`) :user:`49699333+dependabot[bot]`
...
#)  build(deps-dev): bump pytest-xdist[psutil] from 3.4.0 to 3.5.0 (:pull:`2143`) :user:`49699333+dependabot[bot]`
#)  build(deps): update setuptools requirement from <69,>=62.6 to >=62.6,<70 (:pull:`2141`) :user:`49699333+dependabot[bot]`
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2142`) :user:`66853113+pre-commit-ci[bot]`
...
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2130`) :user:`66853113+pre-commit-ci[bot]`
#)  build(deps-dev): bump pytest-xdist[psutil] from 3.3.1 to 3.4.0 (:pull:`2129`) :user:`49699333+dependabot[bot]`
...
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2125`) :user:`66853113+pre-commit-ci[bot]`
...
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2120`) :user:`66853113+pre-commit-ci[bot]`
#)  build(deps): bump wheel from 0.41.2 to 0.41.3 (:pull:`2119`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump pytest from 7.4.2 to 7.4.3 (:pull:`2115`) :user:`49699333+dependabot[bot]`
#)  "Bump version: 6.16.0-dev9 → 6.16.0-dev10 [ci skip]" (:pull:`2114`) :user:`marcelotduarte`
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2113`) :user:`66853113+pre-commit-ci[bot]`
#)  build(deps-dev): bump sphinx-tabs from 3.4.1 to 3.4.4 (:pull:`2112`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump pylint from 3.0.1 to 3.0.2 (:pull:`2111`) :user:`49699333+dependabot[bot]`
...
#)  build(deps-dev): bump pytest-mock from 3.11.1 to 3.12.0 (:pull:`2103`) :user:`49699333+dependabot[bot]`
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2101`) :user:`66853113+pre-commit-ci[bot]`
...
#)  build(deps-dev): bump pre-commit from 3.4.0 to 3.5.0 (:pull:`2096`) :user:`49699333+dependabot[bot]`
#)  hooks: add triton and support for pytorch 2.1 (:pull:`2090`) :user:`marcelotduarte`
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2092`) :user:`66853113+pre-commit-ci[bot]`
#)  build(deps-dev): bump pytest-timeout from 2.1.0 to 2.2.0 (:pull:`2091`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump pylint from 3.0.0 to 3.0.1 (:pull:`2089`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump cibuildwheel from 2.16.1 to 2.16.2 (:pull:`2085`) :user:`49699333+dependabot[bot]`
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2082`) :user:`66853113+pre-commit-ci[bot]`
#)  build(deps-dev): bump pylint from 2.17.6 to 3.0.0 (:pull:`2081`) :user:`49699333+dependabot[bot]`
...
#)  build(deps-dev): bump cibuildwheel from 2.16.0 to 2.16.1 (:pull:`2069`) :user:`49699333+dependabot[bot]`
#)  hooks: move tkinter and tz data to share folder (:pull:`2067`) :user:`marcelotduarte`
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2066`) :user:`66853113+pre-commit-ci[bot]`
#)  build(deps-dev): bump pylint from 2.17.5 to 2.17.6 (:pull:`2065`) :user:`49699333+dependabot[bot]`
...
#)  build(deps-dev): bump cibuildwheel from 2.15.0 to 2.16.0 (:pull:`2056`) :user:`49699333+dependabot[bot]`
...
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2055`) :user:`66853113+pre-commit-ci[bot]`
...
#)  build(deps): bump codecov/codecov-action from 3 to 4 (:pull:`2047`) :user:`49699333+dependabot[bot]`
#)  samples: small tweaks to demonstrate independent options (:pull:`2045`) :user:`marcelotduarte`
#)  build(deps): bump docker/setup-qemu-action from 2 to 3 (:pull:`2044`) :user:`49699333+dependabot[bot]`
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2043`) :user:`66853113+pre-commit-ci[bot]`
...
#)  build(deps-dev): bump pytest from 7.4.1 to 7.4.2 (:pull:`2035`) :user:`49699333+dependabot[bot]`
...
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2031`) :user:`66853113+pre-commit-ci[bot]`
#)  build(deps): bump actions/checkout from 3 to 4 (:pull:`2029`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump pytest from 7.4.0 to 7.4.1 (:pull:`2028`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump pre-commit from 3.3.3 to 3.4.0 (:pull:`2027`) :user:`49699333+dependabot[bot]`
#)  bdis_mac: Builds pass macOS notarization (:pull:`2025`) :user:`johan.ronnkvist`
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2024`) :user:`66853113+pre-commit-ci[bot]`
#)  build(deps-dev): bump pluggy from 1.2.0 to 1.3.0 (:pull:`2023`) :user:`49699333+dependabot[bot]`
...
#)  build(deps-dev): bump wheel from 0.41.1 to 0.41.2 (:pull:`2017`) :user:`49699333+dependabot[bot]`
...
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2007`) :user:`66853113+pre-commit-ci[bot]`
...
#)  build(deps-dev): bump cibuildwheel from 2.14.1 to 2.15.0 (:pull:`2002`) :user:`49699333+dependabot[bot]`
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`2000`) :user:`66853113+pre-commit-ci[bot]`
#)  build(deps-dev): bump wheel from 0.41.0 to 0.41.1 (:pull:`1999`) :user:`49699333+dependabot[bot]`
...
#)  build(deps-dev): bump sphinx from 7.1.1 to 7.1.2 (:pull:`1995`) :user:`49699333+dependabot[bot]`
...
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`1990`) :user:`66853113+pre-commit-ci[bot]`
#)  build(deps-dev): bump sphinx from 7.1.0 to 7.1.1 (:pull:`1989`) :user:`49699333+dependabot[bot]`
#)  hooks: move ssl hook to a submodule (:pull:`1988`) :user:`marcelotduarte`
#)  build(deps-dev): bump pylint from 2.17.4 to 2.17.5 (:pull:`1987`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump sphinx from 7.0.1 to 7.1.0 (:pull:`1985`) :user:`49699333+dependabot[bot]`
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`1983`) :user:`66853113+pre-commit-ci[bot]`
#)  build(deps-dev): bump wheel from 0.40.0 to 0.41.0 (:pull:`1982`) :user:`49699333+dependabot[bot]`
...
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`1973`) :user:`66853113+pre-commit-ci[bot]`
#)  build-wheel: put jobs in concurrency for speedup [skip ci] (:pull:`1971`) :user:`marcelotduarte`
#)  build(deps-dev): bump cibuildwheel from 2.14.0 to 2.14.1 (:pull:`1972`) :user:`49699333+dependabot[bot]`
...
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`1959`) :user:`66853113+pre-commit-ci[bot]`
...
#)  build(deps-dev): bump cibuildwheel from 2.13.1 to 2.14.0 (:pull:`1957`) :user:`49699333+dependabot[bot]`
...
#)  [pre-commit.ci] pre-commit autoupdate (:pull:`1944`) :user:`66853113+pre-commit-ci[bot]`
...
#)  build(deps-dev): bump pytest from 7.3.2 to 7.4.0 (:pull:`1926`) :user:`49699333+dependabot[bot]`
#)  chore: cleanup tests and dependencies (:pull:`1923`) :user:`marcelotduarte`
#)  build(deps): update setuptools requirement from <68,>=62.6 to >=62.6,<69 (:pull:`1919`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump pytest-mock from 3.10.0 to 3.11.1 (:pull:`1918`) :user:`49699333+dependabot[bot]`
...
#)  build(deps-dev): bump cibuildwheel from 2.13.0 to 2.13.1 (:pull:`1909`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump pytest from 7.3.1 to 7.3.2 (:pull:`1908`) :user:`49699333+dependabot[bot]`
...
#)  bases: update base executables and util module :user:`marcelotduarte`
#)  build(deps-dev): bump cibuildwheel from 2.12.3 to 2.13.0 (:pull:`1893`) :user:`49699333+dependabot[bot]`
#)  build(deps-dev): bump pytest-cov from 4.0.0 to 4.1.0 (:pull:`1891`) :user:`49699333+dependabot[bot]`
